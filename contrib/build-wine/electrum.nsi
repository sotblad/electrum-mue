...
;Interface Settings
  ...
  !define MUI_ICON "tmp\electrum-mue\icons\electrum.ico"
...
Section
  ...
  WriteRegStr HKCU "Software\Classes\bitcoin\shell\open\command" "" "$\"$INSTDIR\electrum-mue-${PRODUCT_VERSION}.exe$\" $\"%1$\""
